...
function StepText({
  ...
  // We only want pointer events when the step is visible
          ...
          <div className="relative h-[60vh] md:h-[70vh] w-full flex items-center justify-center">
            <div className="relative w-full max-w-md aspect-square rounded-3xl border border-primary/20 bg-card/40 backdrop-blur-xl shadow-2xl flex items-center justify-center overflow-hidden">
              ...
              <motion.div
                ...
                style={{
                  opacity: useTransform(scrollYProgress, [0.0, 0.25, 0.33], [1, 1, 0]),
                  scale: useTransform(scrollYProgress, [0.0, 0.33], [1, 0.9]),
                  zIndex: 3,
                }}
              >
              ...
              {/* Visual 2 (0.33 to 0.66) */}
              <motion.div
                className="absolute inset-0 flex items-center justify-center p-6 bg-gradient-to-tl from-card to-card/50"
                style={{
                  opacity: useTransform(scrollYProgress, [0.25, 0.33, 0.58, 0.66], [0, 1, 1, 0]),
                  scale: useTransform(scrollYProgress, [0.25, 0.33, 0.66], [0.85, 1, 0.9]),
                  zIndex: 2,
                }}
              >
              ...
              {/* Visual 3 (0.66 to 1.0) */}
              <motion.div
                className="absolute inset-0 flex items-center justify-center p-8 bg-gradient-to-tr from-card to-card/50"
                style={{
                  opacity: useTransform(scrollYProgress, [0.58, 0.66, 1.0], [0, 1, 1]),
                  scale: useTransform(scrollYProgress, [0.58, 0.66, 1.0], [0.9, 1, 1]),
                  zIndex: 1,
                }}
              >
                <div className="relative w-full h-full">
                  <motion.div
                    ...
                    style={{
                      y: useTransform(scrollYProgress, [0.66, 1], [30, -10]),
                      rotate: useTransform(scrollYProgress, [0.66, 1], [-2, 0]),
                    }}
                  >
                  ...
                  <motion.div
                    ...
                    style={{
                      y: useTransform(scrollYProgress, [0.66, 1], [50, -25]),
                      rotate: useTransform(scrollYProgress, [0.66, 1], [3, 0]),
                    }}
                  >
