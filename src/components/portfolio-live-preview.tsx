...
export function PortfolioLivePreview({ portfolioData }: PortfolioLivePreviewProps) {
    const { personalInfo, summary, experience, education, skills, projects, certifications, colorPalette } = portfolioData;
    ...
    return (
        <div className="w-full" style={{ backgroundColor: 'var(--p-bg, hsl(var(--background)))', color: 'var(--p-fg, hsl(var(--foreground)))', ...portfolioStyles }}>
            <div style={{ backgroundColor: 'var(--p-secondary, hsl(var(--card)))' }}>
                {/* Profile Header */}
