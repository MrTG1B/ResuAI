                ...
                <div className="w-full px-4 sm:px-6 md:px-8 pb-4 space-y-2">
                    <div className="max-w-4xl mx-auto">
                        <div className="space-y-2">
                            ...
                            <div className="relative flex w-full items-center rounded-full border bg-card p-2 shadow-lg">
