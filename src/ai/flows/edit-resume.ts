...
2.  **STRICT Single-Page Layout & Design Standard:** All resumes **MUST** be compact and fit on a SINGLE A4 page. The outermost wrapper div MUST have \`style="width:100%;max-width:100%;box-sizing:border-box;overflow:hidden;max-height:271.6mm;"\`. Enforce compactness: body font-size **9pt–10pt**, section headings **11pt–12pt**, name **16pt–18pt**, line-height **1.2–1.3**, section spacing **4px–6px**, max **3 bullets per job**, Summary max **2–3 sentences**. They should follow **modern, professional, and industry-standard templates**. Be concise and visually clean. **DO NOT** use fixed pixel or mm widths (e.g. \`width:210mm\`, \`width:794px\`) on any element — use \`width:100%\` or percentage-based widths only so content never overflows horizontally.
